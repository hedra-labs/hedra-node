...
<details><summary><code>client.jobs.<a href="/src/api/resources/jobs/client/Client.ts">submitMuseImage</a>({ ...params }) -> Hedra.SubmitResponse</code></summary>
<dl>
<dd>
...
```typescript
await client.jobs.submitMuseImage({
    input: {
        prompt: "prompt",
...
**request:** `Hedra.SubmitBodyMuseImage` 
...
<details><summary><code>client.billing.<a href="/src/api/resources/billing/client/Client.ts">listLlmUsage</a>({ ...params }) -> Hedra.LlmUsageRecordListResponse</code></summary>
<dl>
<dd>
...
```typescript
await client.billing.listLlmUsage();
...
**request:** `Hedra.BillingListLlmUsageRequest` 
