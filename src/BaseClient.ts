...
export function normalizeClientOptions<T extends BaseClientOptions = BaseClientOptions>(
    ...
    const headers = mergeHeaders(
        { "X-Fern-Language": "JavaScript", "X-Fern-SDK-Name": "hedra-node", "X-Fern-SDK-Version": "1.0.0-dev", "User-Agent": "hedra-node/1.0.0-dev", "X-Fern-Runtime": core.RUNTIME.type, "X-Fern-Runtime-Version": core.RUNTIME.version, "X-Hedra-Spec-Version": options?.specVersion ?? "3.0.0" },
        options?.headers
    );
