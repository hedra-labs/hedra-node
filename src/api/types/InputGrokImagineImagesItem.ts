...
export type InputGrokImagineImagesItem = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputGrokImagineImagesItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputGrokImagineImagesItem.Asset;

export namespace InputGrokImagineImagesItem {
