...
export type InputSeedance20MiniAudiosItem = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputSeedance20MiniAudiosItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputSeedance20MiniAudiosItem.Asset;

export namespace InputSeedance20MiniAudiosItem {
