 ...
 */
export type InputHedraCharacter3StartImage = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputHedraCharacter3StartImage.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputHedraCharacter3StartImage.Asset;

export namespace InputHedraCharacter3StartImage {
