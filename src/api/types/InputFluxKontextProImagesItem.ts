...
export type InputFluxKontextProImagesItem = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputFluxKontextProImagesItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputFluxKontextProImagesItem.Asset;

export namespace InputFluxKontextProImagesItem {
