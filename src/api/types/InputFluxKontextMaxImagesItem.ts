...
export type InputFluxKontextMaxImagesItem = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputFluxKontextMaxImagesItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputFluxKontextMaxImagesItem.Asset;

export namespace InputFluxKontextMaxImagesItem {
