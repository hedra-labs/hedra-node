 ...
 */
export type InputKling26ProStartImage = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputKling26ProStartImage.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputKling26ProStartImage.Asset;

export namespace InputKling26ProStartImage {
