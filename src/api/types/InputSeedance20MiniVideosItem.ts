...
export type InputSeedance20MiniVideosItem = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputSeedance20MiniVideosItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputSeedance20MiniVideosItem.Asset;

export namespace InputSeedance20MiniVideosItem {
