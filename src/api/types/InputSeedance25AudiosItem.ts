...
export type InputSeedance25AudiosItem =
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputSeedance25AudiosItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputSeedance25AudiosItem.Asset;

export namespace InputSeedance25AudiosItem {
