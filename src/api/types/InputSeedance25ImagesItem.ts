...
export type InputSeedance25ImagesItem =
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputSeedance25ImagesItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputSeedance25ImagesItem.Asset;

export namespace InputSeedance25ImagesItem {
