...
export type InputHappyHorseImagesItem = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputHappyHorseImagesItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputHappyHorseImagesItem.Asset;

export namespace InputHappyHorseImagesItem {
