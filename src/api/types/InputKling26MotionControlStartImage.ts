 ...
 */
export type InputKling26MotionControlStartImage =
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputKling26MotionControlStartImage.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputKling26MotionControlStartImage.Asset;

export namespace InputKling26MotionControlStartImage {
