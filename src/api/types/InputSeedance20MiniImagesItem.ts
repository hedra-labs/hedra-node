...
export type InputSeedance20MiniImagesItem = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputSeedance20MiniImagesItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputSeedance20MiniImagesItem.Asset;

export namespace InputSeedance20MiniImagesItem {
