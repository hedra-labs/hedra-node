 ...
 */
export type InputKling21MasterStartImage = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputKling21MasterStartImage.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputKling21MasterStartImage.Asset;

export namespace InputKling21MasterStartImage {
