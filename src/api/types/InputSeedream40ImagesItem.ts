...
export type InputSeedream40ImagesItem = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputSeedream40ImagesItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputSeedream40ImagesItem.Asset;

export namespace InputSeedream40ImagesItem {
