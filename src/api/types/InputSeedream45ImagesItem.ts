...
export type InputSeedream45ImagesItem = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputSeedream45ImagesItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputSeedream45ImagesItem.Asset;

export namespace InputSeedream45ImagesItem {
