...
export type InputHedraCharacter3AudioZero = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputHedraCharacter3AudioZero.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputHedraCharacter3AudioZero.Asset;

export namespace InputHedraCharacter3AudioZero {
