...
export type InputNanoBanana2ImagesItem = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputNanoBanana2ImagesItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputNanoBanana2ImagesItem.Asset;

export namespace InputNanoBanana2ImagesItem {
