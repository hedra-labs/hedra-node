...
export type InputSeedance25VideosItem =
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputSeedance25VideosItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputSeedance25VideosItem.Asset;

export namespace InputSeedance25VideosItem {
