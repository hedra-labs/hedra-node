...
export type InputNanoBananaProImagesItem = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputNanoBananaProImagesItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputNanoBananaProImagesItem.Asset;

export namespace InputNanoBananaProImagesItem {
