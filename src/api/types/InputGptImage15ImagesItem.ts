...
export type InputGptImage15ImagesItem = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputGptImage15ImagesItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputGptImage15ImagesItem.Asset;

export namespace InputGptImage15ImagesItem {
