...
export type InputKlingO3ReferenceImagesItem =
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputKlingO3ReferenceImagesItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputKlingO3ReferenceImagesItem.Asset;

export namespace InputKlingO3ReferenceImagesItem {
