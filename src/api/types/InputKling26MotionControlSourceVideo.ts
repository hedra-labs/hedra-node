 ...
 */
export type InputKling26MotionControlSourceVideo =
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputKling26MotionControlSourceVideo.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputKling26MotionControlSourceVideo.Asset;

export namespace InputKling26MotionControlSourceVideo {
