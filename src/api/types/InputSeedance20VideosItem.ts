...
export type InputSeedance20VideosItem = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputSeedance20VideosItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputSeedance20VideosItem.Asset;

export namespace InputSeedance20VideosItem {
