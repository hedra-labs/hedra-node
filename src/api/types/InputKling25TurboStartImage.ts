 ...
 */
export type InputKling25TurboStartImage = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputKling25TurboStartImage.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputKling25TurboStartImage.Asset;

export namespace InputKling25TurboStartImage {
