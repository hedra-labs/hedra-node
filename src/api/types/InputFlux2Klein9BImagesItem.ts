...
export type InputFlux2Klein9BImagesItem = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputFlux2Klein9BImagesItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputFlux2Klein9BImagesItem.Asset;

export namespace InputFlux2Klein9BImagesItem {
