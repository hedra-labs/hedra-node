...
export type InputGeminiOmniFlashImagesItem = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputGeminiOmniFlashImagesItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputGeminiOmniFlashImagesItem.Asset;

export namespace InputGeminiOmniFlashImagesItem {
