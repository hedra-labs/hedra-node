...
export type InputSeedream50LiteImagesItem = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputSeedream50LiteImagesItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputSeedream50LiteImagesItem.Asset;

export namespace InputSeedream50LiteImagesItem {
