...
export type InputNanoBananaImagesItem = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputNanoBananaImagesItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputNanoBananaImagesItem.Asset;

export namespace InputNanoBananaImagesItem {
