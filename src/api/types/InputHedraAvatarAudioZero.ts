...
export type InputHedraAvatarAudioZero = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputHedraAvatarAudioZero.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputHedraAvatarAudioZero.Asset;

export namespace InputHedraAvatarAudioZero {
