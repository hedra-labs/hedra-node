...
export type InputHidreamO1ImageImagesItem = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputHidreamO1ImageImagesItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputHidreamO1ImageImagesItem.Asset;

export namespace InputHidreamO1ImageImagesItem {
