 ...
 */
export type InputHedraAvatarStartImage = 
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputHedraAvatarStartImage.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputHedraAvatarStartImage.Asset;

export namespace InputHedraAvatarStartImage {
