...
export type InputKlingO3EditImagesItem =
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputKlingO3EditImagesItem.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputKlingO3EditImagesItem.Asset;

export namespace InputKlingO3EditImagesItem {
