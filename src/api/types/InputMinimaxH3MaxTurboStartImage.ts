 ...
 */
export type InputMinimaxH3MaxTurboStartImage =
    /**
     * A file uploaded via POST /v3/files, referenced by the returned url. */
    | Hedra.InputMinimaxH3MaxTurboStartImage.Url
    /**
     * An existing asset you own, referenced by its id. */
    | Hedra.InputMinimaxH3MaxTurboStartImage.Asset;

export namespace InputMinimaxH3MaxTurboStartImage {
