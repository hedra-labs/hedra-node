...
export declare namespace QueueClient {
...
export class QueueClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<QueueClient.Options>;

    constructor(options: QueueClient.Options = {}) {
        this._options = normalizeClientOptionsWithAuth(options);
    }

    /**
     * @param {string} model
     * @param {Hedra.SubmitRequest} request
     * @param {QueueClient.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    private async __submit(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `queue/${core.url.encodePathParam(model)}`,
            ),
            method: "POST",
            headers: _headers,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/queue/{model}");
    }
}
