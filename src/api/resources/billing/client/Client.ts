...
export class BillingClient {
    ...
    ): Promise<core.WithRawResponse<Hedra.BalanceResponse>> {
    ...
    public getUsage(
        ...
        requestOptions?: BillingClient.RequestOptions,
    ): core.HttpResponsePromise<Hedra.UsageResponse> {
    ...
    private async __getUsage(
        request: Hedra.BillingGetUsageRequest = {},
        requestOptions?: BillingClient.RequestOptions,
    ): Promise<core.WithRawResponse<Hedra.UsageResponse>> {
    ...
    /**
     * @param {Hedra.BillingListLlmUsageRequest} request
     * @param {BillingClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Hedra.BadRequestError}
     * @throws {@link Hedra.UnauthorizedError}
    ...
    public listLlmUsage(
        ...
        requestOptions?: BillingClient.RequestOptions,
    ): core.HttpResponsePromise<Hedra.LlmUsageRecordListResponse> {
        return core.HttpResponsePromise.fromPromise(this.__listLlmUsage(request, requestOptions));
    }

    private async __listLlmUsage(
        request: Hedra.BillingListLlmUsageRequest = {},
        requestOptions?: BillingClient.RequestOptions,
    ): Promise<core.WithRawResponse<Hedra.LlmUsageRecordListResponse>> {
        const { limit, cursor, start, end, model, key_id: keyId } = request;
        const _queryParams: Record<string, unknown> = {
            limit,
            cursor,
            start: start !== undefined ? start : undefined,
        ...
        if (_response.ok) {
            return { data: _response.body as Hedra.LlmUsageRecordListResponse, rawResponse: _response.rawResponse };
        }
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/usage/llm");
    }
}
