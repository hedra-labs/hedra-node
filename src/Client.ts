...
import { QueueClient } from "./api/resources/queue/client/Client.js";
...
export class HedraClient {
    ...
    protected _queue: QueueClient | undefined;
    ...
    public get queue(): QueueClient {
        return (this._queue ??= new QueueClient(this._options));
    }
