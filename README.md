...
await client.assets.upload('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
  file: fs.createReadStream('/path/to/file'),
});

// Or if you have the web `File` API you can pass a `File` instance:
await client.assets.upload('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { file: new File(['my bytes'], 'file') });
